;(function(){
  ...
  var Gun  = (typeof globalThis !== 'undefined' && globalThis.Gun) || (_req && _req('../gun'));
  if (Gun) { Gun.SEA || (_req && _req('../sea')); }
  var SEA  = Gun && Gun.SEA;
  ...
  pen.ready = (function() {
    ...
    // Node.js ESM: require unavailable but dynamic import() works
    if (typeof process !== 'undefined' && process.versions && process.versions.node) {
      return Promise.all([import('fs'), import('path')]).then(function(mods) {
        ...
        var dir = (typeof __dirname !== 'undefined') ? __dirname
                : pm.dirname((typeof __filename !== 'undefined') ? __filename : process.argv[1] || '.');
